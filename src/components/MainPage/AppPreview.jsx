...
const AppPreview = () => {
  return (
    <div className='container-90 my-5'>
        <Row>
            <Col className='d-flex flex-wrap align-content-center gap-3 px-5'>
                <div>
                ...
                <p>
                    Также собраны спортивная литература для саморазвития тела и духа.
                </p>
            ...
            <Col className='col-12 col-md-6'>
                <div className='bg-primary d-flex justify-content-center alignt-items-center py-5 rounded-3'>
